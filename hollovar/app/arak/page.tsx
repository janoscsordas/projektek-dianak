...
const tiers = [
  ...
  },
  {
    ...
    features: [
      ...
      'Közeli erdők felfedezése',
      'Ingyenes svédasztalos ebéd',
      'Korlátlan ital fogyasztás',
      'Lövészet az erdőben',
      'Holló szelidítés megtekintése',
    ],
    featured: true,
  },
]
  ...
  return (
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center lg:max-w-4xl">
        <h2 className="text-base font-semibold leading-7 text-indigo-600">Árak</h2>
        <p className="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
          A tökéletes ár neked, bárki is légy
        </p>
      </div>
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">
        Az áraink változhatnak, ha már kifizetett egy napot a Hollóvárban az ár a megvásárolt időben levő ár marad. A legjobb élményeket nyújtjuk.
      </p>
